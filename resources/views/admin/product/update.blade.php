        ...
        <div class="card">
            <div class="card-body">
                <div class="card-title">
                    <h3 class="text-center title-2">Product Update Form</h3>
                </div>
                <hr>
                <form action="{{ route('admin.product.update') }}" method="post" enctype="multipart/form-data"
                    ...
                    <div class="form-group">
                        ...
                        <input id="cc-payment" name="product_name" value="{{ $product->name }}" type="text"
                    ...
                    <div class="form-group">
                        ...
                        <input id="price" name="price" value="{{ $product->price }}" type="number"
                            class="form-control" aria-required="true" aria-invalid="false" placeholder="Pizza price">
                        @error('price')
                            <small class="text-danger">
                                {{ $message }}
                            </small>
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="des" name="description" class="form-control" placeholder="Description">{{ $product->description }}</textarea>
                        @error('description')
                            <small class="text-danger">
                                {{ $message }}
                            </small>
